...
namespace Possible.Math
{
	public class Financial
	{
		  ...
		  double Guess = 0.1)
		{
			...
			var Rate1 = Guess;
			var num1 = Financial.LEvalRate(Rate1, NPer, Pmt, PV, FV, Due);
			var Rate2 = num1 <= 0.0 ? Rate1 * 2.0 : Rate1 / 2.0;
			var num2 = Financial.LEvalRate(Rate2, NPer, Pmt, PV, FV, Due);
			var num3 = 0;
			do
			{
				if (num2 == num1)
				...
				var num5 = Financial.LEvalRate(Rate3, NPer, Pmt, PV, FV, Due);
